...
# For some reason this one surprised me as I imagined people living in the UP having to drive far to "get into town" so to speak.  But it would seem that the opposite is true.  I assume this is because the communities in the UP all live in smaller towns and only travel far when need be.  On the other hand, I know many people who drive an hour or more each day to get down to Detroit.  I'm a bad guesser I suppose.
...
# I was again surpirsed by this one with there being so many professionals in the UP compared to the LP.  This is evident by the mass of the box along the line.  Of course, the LP has higher outliers on this mark, but that was a give away.
...
# From the graph, I can conclude that the UP has a denser population of those that descend from the Angol-Saxon heritage as compared to the LP.
...
# From the graph, I can conclude that the UP has a much denser population of those that descend from the Native American heritage as compared to the LP.
